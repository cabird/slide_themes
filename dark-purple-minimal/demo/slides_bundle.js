  ...
  const slides = [
    ...
    // ================================================================
    {
      ...
      elements: [
        ...
        J(`<h1 style="font-family:${FONT},sans-serif;font-size:72px;font-weight:600;color:${C.textPrimary};line-height:1.1;letter-spacing:-0.02em;">Plan. Track.<br>Ship faster.</h1>`, {
          id: "s1-title",
          x: leftX,
          y: Ne("s1-section", { gap: 16 }),
          w: 800,
          h: 170
        }),
        J(`<p style="font-family:${FONT},sans-serif;font-size:22px;font-weight:400;color:${C.textSecondary};line-height:1.55;">The project management tool built for modern engineering teams. Streamline brings clarity to every sprint, every cycle, every milestone.</p>`, {
          id: "s1-body",
          x: leftX,
          y: Ne("s1-title", { gap: 32 }),
          w: 672
        }),
        J(`<p style="font-family:${FONT},sans-serif;font-size:20px;font-weight:500;color:${C.textPrimary};">Get started free \u2192</p>`, {
          id: "s1-cta",
          x: leftX,
          y: Ne("s1-body", { gap: 36 }),
          w: 300
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        ...
        const elements = [
          ...
          J(`<h2 style="font-family:${FONT},sans-serif;font-size:52px;font-weight:600;color:${C.textPrimary};line-height:1.15;letter-spacing:-0.02em;">Everything you<br>need to ship</h2>`, {
            id: "s2-title",
            x: leftX,
            y: Ne("s2-section", { gap: 16 }),
            w: leftW,
            h: 130
          }),
          J(`<p style="font-family:${FONT},sans-serif;font-size:20px;font-weight:400;color:${C.textSecondary};line-height:1.55;">A purpose-built toolkit for engineering teams who refuse to compromise on speed or quality.</p>`, {
            id: "s2-body",
            x: leftX,
            y: Ne("s2-title", { gap: 32 }),
            w: leftW
          })
        ];
        for (let i = 0; i < cards.length; i++) {
          ...
          elements.push(
            J(`<div style="width:100%;height:100%;background:${C.bgSecondary};border:1px solid ${C.border};border-radius:8px;padding:28px;box-sizing:border-box;">
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        ...
        const elements = [
          ...
          J(`<h2 style="font-family:${FONT},sans-serif;font-size:52px;font-weight:600;color:${C.textPrimary};line-height:1.15;letter-spacing:-0.02em;">Built for teams<br>who ship</h2>`, {
            id: "s3-title",
            x: leftX,
            y: Ne("s3-section", { gap: 16 }),
            w: leftW,
            h: 130
          })
        ];
        ...
        for (let i = 0; i < benefits.length; i++) {
          ...
          const gap = i === 0 ? 36 : 24;
          elements.push(
            J(`<div style="width:100%;height:100%;border-radius:50%;background:${C.bgSecondary};border:1px solid ${C.border};display:flex;align-items:center;justify-content:center;">
              <div style="width:22px;height:22px;">${featureIcon(b.icon)}</div>
            </div>`, {
              id: iconId,
              x: leftX,
              y: Ne(lastBenefitId, { gap }),
              w: 44,
              h: 44
            })
          );
          elements.push(
            J(`<p style="font-family:${FONT},sans-serif;font-size:18px;font-weight:600;color:${C.textPrimary};line-height:44px;">${b.title}</p>`, {
              id: titleId,
              x: leftX + 60,
              y: Ne(lastBenefitId, { gap }),
              w: leftW - 60,
          ...
          elements.push(
            J(`<p style="font-family:${FONT},sans-serif;font-size:18px;font-weight:400;color:${C.textSecondary};line-height:1.5;">${b.desc}</p>`, {
              id: descId,
              x: leftX + 60,
              y: Ne(titleId, { gap: 2 }),
              w: leftW - 60
        ...
        for (let i = 0; i < quotes.length; i++) {
          ...
          const qy = i === 0 ? topY + 40 : void 0;
          elements.push(
            J(`<div style="width:100%;box-sizing:border-box;border-left:4px solid ${C.accent};padding-left:24px;">
              <p style="font-family:${FONT},sans-serif;font-size:20px;font-weight:400;color:${C.quoteText};line-height:1.6;margin:0;">${q.text}</p>
            </div>`, {
              id: qId,
              x: quoteX,
              y: qy !== void 0 ? qy : Ne(lastQuoteId, { gap: 48 }),
              w: quoteW
            })
          );
          elements.push(
            J(`<p style="font-family:${FONT},sans-serif;font-size:18px;font-weight:600;color:${C.textPrimary};margin:0;">\u2014 ${q.company}</p>`, {
              id: qAttrId,
              x: quoteX + 28,
              y: Ne(qId, { gap: 16 }),
              w: quoteW - 28
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        ...
        return [
          ...
          J(`<h2 style="font-family:${FONT},sans-serif;font-size:52px;font-weight:600;color:${C.textPrimary};line-height:1.15;letter-spacing:-0.02em;">Track every<br>issue with clarity</h2>`, {
            id: "s4-title",
            x: leftX,
            y: Ne("s4-section", { gap: 16 }),
            w: leftW,
            h: 130
          }),
          J(`<p style="font-family:${FONT},sans-serif;font-size:20px;font-weight:400;color:${C.textSecondary};line-height:1.55;">Create, assign, and prioritize issues in seconds. Smart filters and custom views let you see exactly what matters \u2014 nothing more, nothing less.</p>`, {
            id: "s4-body",
            x: leftX,
            y: Ne("s4-title", { gap: 32 }),
            w: leftW
          }),
          J(`<p style="font-family:${FONT},sans-serif;font-size:20px;font-weight:500;color:${C.textPrimary};">See all features \u2192</p>`, {
            id: "s4-cta",
            x: leftX,
            y: Ne("s4-body", { gap: 36 }),
            w: 300
    ...
    // ================================================================
    {
      ...
      elements: [
        ...
        J(`<h2 style="font-family:${FONT},sans-serif;font-size:64px;font-weight:600;color:${C.textPrimary};line-height:1.15;letter-spacing:-0.02em;text-align:center;">Ready to streamline<br>your workflow?</h2>`, {
          id: "s5-title",
          x: 960,
          y: 360,
          w: 1100,
        ...
        J(`<p style="font-family:${FONT},sans-serif;font-size:22px;font-weight:400;color:${C.textSecondary};line-height:1.55;text-align:center;">Join thousands of engineering teams building better software with Streamline. Free for teams up to 10.</p>`, {
          id: "s5-body",
          x: 960,
          y: Ne("s5-title", { gap: 32 }),
          w: 800,
          anchor: "tc"
        }),
        // CTA button
        J(`<div style="display:inline-block;background:${C.accent};padding:14px 40px;border-radius:6px;">
        ...
        // URL
        J(`<p style="font-family:${FONT},sans-serif;font-size:18px;font-weight:400;color:${C.textTertiary};text-align:center;">streamline.dev</p>`, {
          id: "s5-url",
          x: 960,
          y: Ne("s5-cta", { gap: 24 }),
          w: 300,
