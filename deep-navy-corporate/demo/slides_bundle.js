...
var FONT = "DM Sans";
var ACCENTS = [C.accent1, C.accent2, C.accent3, C.accent5];
...
function footer(slideNum, id, dark = true) {
  ...
  return [
    J(`<p style="font-family:${FONT};font-size:14px;font-weight:500;color:${brandColor};letter-spacing:0.05em;text-transform:uppercase;">AstroVentures</p>`, {
      id: `${id}-brand`,
      x: 120,
      y: 970,
      w: 200
    }),
    J(`<p style="font-family:${FONT};font-size:14px;font-weight:400;color:${numColor};text-align:right;">${slideNum}</p>`, {
      id: `${id}-num`,
      x: 1660,
      y: 970,
      w: 80
...
function dividerLine(id, x, y) {
  return J("", { id, x, y, w: 60, h: 3, style: { background: C.accent1, borderRadius: "2px" } });
}
function bgVignette(id) {
  return J(`<div style="width:100%;height:100%;background:radial-gradient(ellipse at center, ${C.bgTertiary} 0%, ${C.bgPrimary} 70%, #110E40 100%);"></div>`, {
    id,
    x: 0,
    y: 0,
    w: 1920,
  ...
  const slides = [
    ...
    // ================================================================
    {
      ...
      elements: [
        ...
        logoLockup("s1-logo"),
        // Headline
        J(`<h1 style="font-family:${FONT};font-size:82px;font-weight:700;color:${C.textPrimary};line-height:1.1;letter-spacing:-0.02em;">The Future of<br><span style="font-weight:400;">Space</span> <strong>Tourism</strong></h1>`, {
          id: "s1-title",
          x: safe.x,
          y: safe.y + 180,
          w: 1e3,
        ...
        dividerLine("s1-divider", safe.x, Ne("s1-title", { gap: 28 })),
        J(`<p style="font-family:${FONT};font-size:24px;font-weight:400;color:${C.textSecondary};line-height:1.6;">Commercial spaceflight is no longer science fiction.<br>Discover the companies, technology, and economics shaping humanity's next great adventure.</p>`, {
          id: "s1-subtitle",
          x: safe.x,
          y: Ne("s1-divider", { gap: 24 }),
          w: 780
        }),
        // Decorative dot accents
        J("", { id: "s1-dot1", x: 1650, y: 200, w: 12, h: 12, style: { background: C.accent1, borderRadius: "50%" }, opacity: 0.5 }),
        J("", { id: "s1-dot2", x: 1700, y: 260, w: 8, h: 8, style: { background: C.accent3, borderRadius: "50%" }, opacity: 0.4 }),
        ...footer("01", "s1-ft"),
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        ...
        const elements = [
          bgVignette("s2-vig"),
          logoLockup("s2-logo"),
          J(`<p style="font-family:${FONT};font-size:14px;font-weight:500;color:${C.accent1};text-transform:uppercase;letter-spacing:4px;">Our Story</p>`, {
            id: "s2-eyebrow",
            x: safe.x,
            y: safe.y + 60,
            w: 400
          }),
          J(`<h2 style="font-family:${FONT};font-size:48px;font-weight:700;color:${C.textPrimary};line-height:1.2;letter-spacing:-0.01em;"><span style="font-weight:400;">Space Tourism</span> <strong>by the Numbers</strong></h2>`, {
            id: "s2-title",
            x: safe.x,
            y: Ne("s2-eyebrow", { gap: 16 }),
            w: 700,
            h: 120
          }),
          dividerLine("s2-divider", safe.x, Ne("s2-title", { gap: 16 }))
        ];
        for (let i = 0; i < stats.length; i++) {
          const s = stats[i];
          const cx = safe.x + i * (cardW + gap);
          elements.push(
            J(`<div style="border:1px solid ${C.border};border-radius:8px;padding:36px 24px;text-align:center;">
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        const { left, right } = en(safe, { ratio: 0.52, gap: 60 });
        return [
          bgVignette("s3-vig"),
          logoLockup("s3-logo"),
          // Left: text
          J(`<p style="font-family:${FONT};font-size:14px;font-weight:500;color:${C.accent1};text-transform:uppercase;letter-spacing:4px;">Overview</p>`, {
            id: "s3-eyebrow",
            x: left.x,
            y: left.y + 60,
            w: left.w
          }),
          J(`<h2 style="font-family:${FONT};font-size:44px;font-weight:700;color:${C.textPrimary};line-height:1.2;letter-spacing:-0.01em;"><span style="font-weight:400;">Orbital</span> <strong>Experiences</strong></h2>`, {
            id: "s3-title",
            x: left.x,
            y: Ne("s3-eyebrow", { gap: 16 }),
            w: left.w,
            h: 110
          }),
          dividerLine("s3-divider", left.x, Ne("s3-title", { gap: 16 })),
          J(`<p style="font-family:${FONT};font-size:20px;font-weight:400;color:${C.textSecondary};line-height:1.7;">From suborbital hops lasting minutes to week-long stays aboard commercial space stations, the range of experiences is expanding rapidly. Ticket prices have dropped from $55M to under $500K in a decade.</p>`, {
            id: "s3-body1",
            x: left.x,
            y: Ne("s3-divider", { gap: 24 }),
            w: left.w
          }),
          J(`<p style="font-family:${FONT};font-size:20px;font-weight:400;color:${C.textSecondary};line-height:1.7;">By 2030, analysts project over <strong style="color:${C.textPrimary};">10,000 passengers per year</strong> will travel beyond the K\xE1rm\xE1n line.</p>`, {
            id: "s3-body2",
            x: left.x,
            y: Ne("s3-body1", { gap: 20 }),
            w: left.w
          }),
          // Right: UI mockup card
          J(`<div style="background:${C.bgTertiary};border:1px solid ${C.border};border-radius:10px;padding:32px;">
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        ...
        const elements = [
          ...
          J(`<p style="font-family:${FONT};font-size:14px;font-weight:500;color:${C.accent3};text-transform:uppercase;letter-spacing:4px;">How It Works</p>`, {
            id: "s4-eyebrow",
            x: safe.x,
            y: safe.y + 80,
            w: 400
          }),
          J(`<h2 style="font-family:${FONT};font-size:44px;font-weight:700;color:${C.textPrimaryDk};line-height:1.2;letter-spacing:-0.01em;"><span style="font-weight:400;">Your Journey</span> <strong>to Space</strong></h2>`, {
            id: "s4-title",
            x: safe.x,
            y: Ne("s4-eyebrow", { gap: 16 }),
            w: 600,
            h: 110
          }),
          J(`<p style="font-family:${FONT};font-size:20px;font-weight:400;color:${C.textSecDark};line-height:1.6;">From application to splashdown \u2014 the four-step process that takes you from Earth to orbit and back safely.</p>`, {
            id: "s4-desc",
            x: safe.x,
            y: Ne("s4-title", { gap: 12 }),
            w: 700
          })
        ];
        ...
        for (let i = 0; i < steps.length; i++) {
          ...
          elements.push(
            J(`<div style="width:${circleSize}px;height:${circleSize}px;border-radius:50%;background:${s.color};display:flex;align-items:center;justify-content:center;">
          ...
          elements.push(
            J(`<p style="font-family:${FONT};font-size:20px;font-weight:500;color:${C.textPrimaryDk};line-height:1.3;text-align:center;">${s.title}</p>`, {
              id: `s4-step-title${i}`,
              x: cx,
              y: Ne(`s4-circle${i}`, { gap: 20 }),
              w: cardW,
              style: { textAlign: "center" }
            })
          );
          elements.push(
            J(`<p style="font-family:${FONT};font-size:15px;font-weight:400;color:${C.textSecDark};line-height:1.6;text-align:center;">${s.desc}</p>`, {
              id: `s4-step-desc${i}`,
              x: cx,
              y: Ne(`s4-step-title${i}`, { gap: 10 }),
              w: cardW,
              style: { textAlign: "center" }
            })
          );
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        const categories = [
          { icon: "\u{1F680}", title: "Suborbital Flights", desc: "Brief weightlessness at the edge of space, perfect for first-timers.", color: C.accent1 },
          { icon: "\u{1F6F0}\uFE0F", title: "Orbital Stays", desc: "Multi-day missions aboard commercial space stations in LEO.", color: C.accent2 },
          { icon: "\u{1F319}", title: "Lunar Flybys", desc: "Circle the Moon and witness Earthrise from cislunar space.", color: C.accent3 },
          { icon: "\u{1F52D}", title: "Space Research", desc: "Private microgravity labs for scientific experiments.", color: C.accent5 },
          { icon: "\u{1F3D7}\uFE0F", title: "Station Modules", desc: "Modular habitats for corporate events and film production.", color: C.accent2 },
          { icon: "\u{1F30D}", title: "Zero-G Training", desc: "Parabolic flight programs for pre-mission preparation.", color: C.accent1 }
        ];
        const cols = 3;
        const rows = 2;
        const gap = 28;
        ...
        const elements = [
          bgVignette("s5-vig"),
          logoLockup("s5-logo"),
          J(`<p style="font-family:${FONT};font-size:14px;font-weight:500;color:${C.accent1};text-transform:uppercase;letter-spacing:4px;">Services</p>`, {
            id: "s5-eyebrow",
            x: safe.x,
            y: safe.y + 50,
            w: 400
          }),
          J(`<h2 style="font-family:${FONT};font-size:44px;font-weight:700;color:${C.textPrimary};line-height:1.2;letter-spacing:-0.01em;"><span style="font-weight:400;">Experience</span> <strong>Categories</strong></h2>`, {
            id: "s5-title",
            x: safe.x,
            y: Ne("s5-eyebrow", { gap: 14 }),
            w: 600,
            h: 60
          })
        ];
        for (let i = 0; i < categories.length; i++) {
          ...
          elements.push(
            J(`<div style="border:1px solid ${C.border};border-radius:8px;padding:28px;">
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        ...
        const { left, right } = en(safe, { ratio: 0.5, gap: 60 });
        ...
        const elements = [
          bgVignette("s6-vig"),
          logoLockup("s6-logo"),
          J(`<p style="font-family:${FONT};font-size:14px;font-weight:500;color:${C.accent2};text-transform:uppercase;letter-spacing:4px;">Key Benefits</p>`, {
            id: "s6-eyebrow",
            x: safe.x,
            y: safe.y + 50,
            w: 400
          }),
          J(`<h2 style="font-family:${FONT};font-size:44px;font-weight:700;color:${C.textPrimary};line-height:1.2;letter-spacing:-0.01em;"><span style="font-weight:400;">Why</span> <strong>Space Tourism?</strong></h2>`, {
            id: "s6-title",
            x: safe.x,
            y: Ne("s6-eyebrow", { gap: 14 }),
            w: 600,
            h: 60
          }),
          dividerLine("s6-divider", safe.x, Ne("s6-title", { gap: 14 }))
        ];
        for (let i = 0; i < items.length; i++) {
          ...
          const numW = 80;
          elements.push(
            J(`<p style="font-family:${FONT};font-size:56px;font-weight:700;color:${C.accent2};line-height:1.0;letter-spacing:-0.02em;">${num}</p>`, {
              id: `s6-num${i}`,
              x: col.x,
              y: yPos,
              w: numW
            }),
            J(`<p style="font-family:${FONT};font-size:20px;font-weight:500;color:${C.textPrimary};line-height:1.3;margin:0 0 8px 0;">${item.title}</p>`, {
              id: `s6-item-title${i}`,
              x: col.x + numW + 16,
              y: yPos,
              w: col.w - numW - 16
            }),
            J(`<p style="font-family:${FONT};font-size:15px;font-weight:400;color:${C.textSecondary};line-height:1.6;">${item.desc}</p>`, {
              id: `s6-item-desc${i}`,
              x: col.x + numW + 16,
              y: Ne(`s6-item-title${i}`, { gap: 8 }),
              w: col.w - numW - 16
            })
          );
        }
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        ...
        return [
          ...
          J(`<p style="font-family:${FONT};font-size:14px;font-weight:500;color:${C.accent3};text-transform:uppercase;letter-spacing:4px;">Detailed Analysis</p>`, {
            id: "s7-eyebrow",
            x: safe.x,
            y: safe.y + 60,
            w: 400
          }),
          J(`<h2 style="font-family:${FONT};font-size:42px;font-weight:700;color:${C.textPrimaryDk};line-height:1.2;letter-spacing:-0.01em;"><span style="font-weight:400;">Regulatory</span> <strong>Framework</strong></h2>`, {
            id: "s7-title",
            x: safe.x,
            y: Ne("s7-eyebrow", { gap: 14 }),
            w: safe.w,
            h: 56
          }),
          J("", {
            id: "s7-divider",
            x: safe.x,
            y: Ne("s7-title", { gap: 16 }),
            w: safe.w,
            h: 1,
            style: { background: C.borderLight }
          }),
          // Left column
          J(`<p style="font-family:${FONT};font-size:22px;font-weight:500;color:${C.textPrimaryDk};line-height:1.3;margin:0 0 12px 0;">Licensing & Compliance</p>`, {
            id: "s7-sub1",
            x: left.x,
            y: Ne("s7-divider", { gap: 28 }),
            w: left.w
          }),
          J(`<p style="font-family:${FONT};font-size:16px;font-weight:400;color:${C.textSecDark};line-height:1.7;">The FAA's Office of Commercial Space Transportation oversees all US launch and re-entry operations. Operators must obtain a launch license, demonstrate vehicle safety through rigorous testing, and carry liability insurance. The regulatory "learning period" established in 2004 has been extended through 2028, allowing the industry to innovate while building a safety track record.</p>`, {
            id: "s7-para1",
            x: left.x,
            y: Ne("s7-sub1", { gap: 10 }),
            w: left.w
          }),
          J(`<p style="font-family:${FONT};font-size:22px;font-weight:500;color:${C.textPrimaryDk};line-height:1.3;margin:0 0 12px 0;">Passenger Safety Standards</p>`, {
            id: "s7-sub2",
            x: left.x,
            y: Ne("s7-para1", { gap: 24 }),
            w: left.w
          }),
          ...
          // Right column
          J(`<p style="font-family:${FONT};font-size:22px;font-weight:500;color:${C.textPrimaryDk};line-height:1.3;margin:0 0 12px 0;">International Coordination</p>`, {
            id: "s7-sub3",
            x: right.x,
            y: Ne("s7-divider", { gap: 28 }),
            w: right.w
          ...
          J(`<p style="font-family:${FONT};font-size:22px;font-weight:500;color:${C.textPrimaryDk};line-height:1.3;margin:0 0 12px 0;">Insurance & Liability</p>`, {
            id: "s7-sub4",
            x: right.x,
            y: Ne("s7-para3", { gap: 24 }),
            w: right.w
          }),
