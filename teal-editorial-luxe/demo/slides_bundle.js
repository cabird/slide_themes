...
function pt(e, t, n = {}) {
  let { id: o, ...r } = n, l = o || Z(), i = { connectorType: r.type || "straight", arrow: r.arrow ?? "end", color: r.color || "#ffffff", thickness: r.thickness ?? 2, dash: r.dash || null, fromAnchor: r.fromAnchor || "cr", toAnchor: r.toAnchor || "cl", label: r.label || null, labelStyle: r.labelStyle || {}, fromId: e, toId: t, x: 0, y: 0, layer: r.layer || "content", opacity: r.opacity ?? 1, style: r.style || {}, className: r.className || "", anchor: "tl" };
  return { id: l, type: "connector", props: i, _layoutFlags: {} };
}
function ue(e, t) {
...
function headingRule(id, x, y, w = 120) {
  return J("", { id, x, y, w, h: 1, style: { background: C.border } });
}
function photoPlaceholder(id, x, y, w, h, hue = 190) {
  return J(
    `<div style="width:100%;height:100%;background:linear-gradient(135deg, hsl(${hue},30%,40%), hsl(${hue + 20},25%,30%));display:flex;align-items:center;justify-content:center;">
      <p style="font-family:${SANS};font-size:16px;font-weight:300;color:rgba(255,255,255,0.35);letter-spacing:0.1em;text-transform:uppercase;">Photo</p>
    </div>`,
    { id, x, y, w, h }
  );
}
async function run() {
  ...
  const slides = [
    ...
    // ================================================================
    {
      ...
      elements: [
        // Photo panel LEFT
        photoPlaceholder("s1-photo", 0, 0, panelW, 1080, 35),
        // Content panel RIGHT
        J("", {
          id: "s1-bg",
          x: panelW,
        ...
        J(`<h1 style="font-family:${SERIF};font-size:96px;font-weight:700;color:${C.textPrimary};line-height:1.05;letter-spacing:-0.01em;">The Art of<br><em style="font-weight:400;font-style:italic;">Typography</em></h1>`, {
          id: "s1-title",
          x: panelW + panelPad.x,
          y: 320,
          w: contentW,
        ...
        headingRule("s1-rule", panelW + panelPad.x, Ne("s1-title", { gap: 28 }), 100),
        J(`<p style="font-family:${SANS};font-size:22px;font-weight:300;color:${C.textMuted};line-height:1.6;letter-spacing:0.02em;">A visual journey through the history, craft,<br>and beauty of letterforms.</p>`, {
          id: "s1-sub",
          x: panelW + panelPad.x,
          y: Ne("s1-rule", { gap: 24 }),
          w: contentW
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        ...
        const elements = [
          ...
          J(`<h2 style="font-family:${SERIF};font-size:56px;font-weight:700;color:${C.textPrimary};line-height:1.1;">Table of<br><em style="font-weight:400;font-style:italic;">contents</em></h2>`, {
            id: "s2-title",
            x: cx,
            y: safe.y + 40,
            w: 500,
        ...
        for (let i = 0; i < sections.length; i++) {
          ...
          elements.push(
            ...
            J(`<p style="font-family:${SERIF};font-size:64px;font-weight:700;color:${C.textPrimary};line-height:1;">${s.num}</p>`, {
              id: `s2-num${i}`,
              x: cx,
              y: yPos + 24,
              w: 120,
            ...
            J(`<p style="font-family:${SERIF};font-size:32px;font-weight:400;font-style:italic;color:${C.textPrimary};line-height:1.2;">${s.title}</p>`, {
              id: `s2-stitle${i}`,
              x: cx + 140,
              y: yPos + 30,
              w: 350,
            ...
            J(`<p style="font-family:${SANS};font-size:18px;font-weight:300;color:${C.textMuted};line-height:1.5;letter-spacing:0.02em;">${s.desc}</p>`, {
              id: `s2-desc${i}`,
              x: cx + 140,
              y: yPos + 80,
              w: 600
    ...
    // ================================================================
    {
      ...
      elements: [
        ...
        photoPlaceholder("s3-photo", panelW, 0, panelW, 1080, 200),
        lBorder("s3-lb-tl", contentX, 100, 140, 140, "tl"),
        lBorder("s3-lb-br", panelW - contentX - 140, 1080 - 240, 140, 140, "br"),
        J(`<p style="font-family:${SERIF};font-size:160px;font-weight:700;color:${C.textPrimary};line-height:1;">01</p>`, {
          id: "s3-num",
          x: contentX,
          y: 180,
          w: 400,
        ...
        J(`<h2 style="font-family:${SERIF};font-size:52px;font-weight:700;color:${C.textPrimary};line-height:1.1;">The <em style="font-weight:400;font-style:italic;">Origins</em></h2>`, {
          id: "s3-title",
          x: contentX,
          y: 440,
          w: contentW,
        ...
        headingRule("s3-rule", contentX, Ne("s3-title", { gap: 24 }), 100),
        J(`<p style="font-family:${SANS};font-size:20px;font-weight:300;color:${C.textMuted};line-height:1.6;letter-spacing:0.02em;">Tracing the evolution of written<br>communication from ancient scripts<br>to the printing press.</p>`, {
          id: "s3-desc",
          x: contentX,
          y: Ne("s3-rule", { gap: 20 }),
          w: contentW
    ...
    // ================================================================
    {
      ...
      elements: [
        ...
        photoPlaceholder("s4-photo", panelW, 0, panelW, 1080, 25),
        lBorder("s4-lb-tl", contentX - 20, 80, 120, 120, "tl"),
        J(`<h2 style="font-family:${SERIF};font-size:48px;font-weight:700;color:${C.textPrimary};line-height:1.1;">One <em style="font-weight:400;font-style:italic;">column</em></h2>`, {
          id: "s4-title",
          x: contentX,
          y: safe.y + 40,
          w: contentW,
        ...
        headingRule("s4-rule", contentX, Ne("s4-title", { gap: 20 }), 100),
        J(`<p style="font-family:${SANS};font-size:20px;font-weight:300;color:${C.textMuted};line-height:1.7;letter-spacing:0.02em;">The Phoenician alphabet, developed around 1050 BCE, was a pivotal innovation \u2014 the first widely used phonetic writing system. Each symbol represented a consonant sound rather than a word or syllable.</p>`, {
          id: "s4-body1",
          x: contentX,
          y: Ne("s4-rule", { gap: 24 }),
          w: contentW
        }),
        J(`<p style="font-family:${SANS};font-size:20px;font-weight:300;color:${C.textMuted};line-height:1.7;letter-spacing:0.02em;">This breakthrough spread through Mediterranean trade routes, eventually giving rise to Greek, Latin, and Arabic scripts \u2014 the ancestors of nearly every modern alphabet.</p>`, {
          id: "s4-body2",
          x: contentX,
          y: Ne("s4-body1", { gap: 20 }),
          w: contentW
        }),
        J(`<ul style="font-family:${SANS};font-size:18px;font-weight:300;color:${C.textMuted};line-height:2.0;letter-spacing:0.02em;list-style:disc;padding-left:20px;">
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        ...
        return [
          ...
          photoPlaceholder("s5-photo", panelW, 0, panelW, 1080, 350),
          lBorder("s5-lb-tr", panelW - contentX - 140, 80, 120, 120, "tr"),
          J(`<h2 style="font-family:${SERIF};font-size:48px;font-weight:700;color:${C.textPrimary};line-height:1.1;">Two <em style="font-weight:400;font-style:italic;">columns</em></h2>`, {
            id: "s5-title",
            x: contentX,
            y: safe.y + 40,
            w: contentW,
          ...
          headingRule("s5-rule", contentX, Ne("s5-title", { gap: 20 }), 100),
          // Column A
          J(`<p style="font-family:${SANS};font-size:17px;font-weight:400;color:${C.textPrimary};line-height:1.3;letter-spacing:0.04em;text-transform:uppercase;margin:0 0 12px 0;">Serif Typefaces</p>
          ...
          // Column B
          J(`<p style="font-family:${SANS};font-size:17px;font-weight:400;color:${C.textPrimary};line-height:1.3;letter-spacing:0.04em;text-transform:uppercase;margin:0 0 12px 0;">Sans-Serif Typefaces</p>
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        ...
        const elements = [
          ...
          J(`<h2 style="font-family:${SERIF};font-size:48px;font-weight:700;color:${C.textPrimary};line-height:1.1;">Three <em style="font-weight:400;font-style:italic;">columns</em></h2>`, {
            id: "s6-title",
            x: cx,
            y: safe.y + 40,
            w: totalW,
          ...
          headingRule("s6-rule", cx, Ne("s6-title", { gap: 20 }), 100)
        ];
        for (let i = 0; i < items.length; i++) {
          const item = items[i];
          const colX = cx + i * (colW + gap);
          elements.push(
            J(`<p style="font-family:${SERIF};font-size:28px;font-weight:400;font-style:italic;color:${C.textPrimary};line-height:1.2;margin:0 0 16px 0;">${item.title}</p>
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        ...
        return [
          ...
          J(`<h2 style="font-family:${SERIF};font-size:48px;font-weight:700;color:${C.textPrimary};line-height:1.1;">Serif vs. <em style="font-weight:400;font-style:italic;">Sans-Serif</em></h2>`, {
            id: "s7-title",
            x: cx,
            y: safe.y + 40,
            w: totalW
          }),
          headingRule("s7-rule", cx, Ne("s7-title", { gap: 20 }), 100),
          // Left block
          J(`<p style="font-family:${SERIF};font-size:32px;font-weight:400;font-style:italic;color:${C.textPrimary};line-height:1.2;margin:0 0 20px 0;">Serif</p>
          ...
          // Right block
          J(`<p style="font-family:${SERIF};font-size:32px;font-weight:400;font-style:italic;color:${C.textPrimary};line-height:1.2;margin:0 0 20px 0;">Sans-Serif</p>
          <div style="width:60px;height:1px;background:${C.border};margin:0 0 24px 0;"></div>
          <ul style="font-family:${SANS};font-size:18px;font-weight:300;color:${C.textMuted};line-height:2.0;letter-spacing:0.02em;list-style:none;padding:0;">
    ...
    // ================================================================
    {
      ...
      elements: [
        ...
        J(`<p style="font-family:${SERIF};font-size:42px;font-weight:400;font-style:italic;color:${C.textPrimary};line-height:1.45;text-align:left;">Typography is the craft of endowing<br>human language with a durable<br>visual form.</p>`, {
          id: "s8-quote",
          x: 960 - 550,
          y: 340,
          w: 1100
        }),
        J(`<p style="font-family:${SANS};font-size:18px;font-weight:300;color:${C.textMuted};letter-spacing:0.05em;">\u2014 Robert Bringhurst</p>`, {
          id: "s8-attr",
          x: 960 - 550,
          y: Ne("s8-quote", { gap: 40 }),
          w: 400
        }),
        headingRule("s8-rule", 960 - 550, Ne("s8-attr", { gap: 24 }), 80),
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        ...
        const colWidths = [0.18, 0.22, 0.1, 0.25, 0.25];
        const rowH = 52;
        ...
        const elements = [
          ...
          J(`<h2 style="font-family:${SERIF};font-size:48px;font-weight:700;color:${C.textPrimary};line-height:1.1;">Data <em style="font-weight:400;font-style:italic;">table</em></h2>`, {
            id: "s9-title",
            x: tx,
            y: safe.y + 40,
            w: tw
          }),
          headingRule("s9-rule", tx, Ne("s9-title", { gap: 20 }), 100)
        ];
        let colX = tx;
        for (let c = 0; c < headers.length; c++) {
          const w = tw * colWidths[c];
          elements.push(
            J(`<p style="font-family:${SANS};font-size:14px;font-weight:400;color:${C.textPrimary};text-transform:uppercase;letter-spacing:0.06em;">${headers[c]}</p>`, {
              id: `s9-h${c}`,
              x: colX,
              y: headerY,
              w,
        ...
        elements.push(
          J("", { id: "s9-hline", x: tx, y: headerY + 36, w: tw, h: 1, style: { background: C.border } })
        );
        for (let r = 0; r < rows.length; r++) {
          ...
          for (let c = 0; c < rows[r].length; c++) {
            const w = tw * colWidths[c];
            elements.push(
              J(`<p style="font-family:${SANS};font-size:16px;font-weight:300;color:${C.textMuted};line-height:1.4;">${rows[r][c]}</p>`, {
                id: `s9-r${r}c${c}`,
                x: colX,
                y: ry,
                w,
    ...
    // ================================================================
    {
      ...
      elements: [
        ...
        photoPlaceholder("s10-photo", panelW, 0, panelW, 1080, 10),
        lBorder("s10-lb-tl", contentX - 20, 80, 120, 120, "tl"),
        J(`<h2 style="font-family:${SERIF};font-size:48px;font-weight:700;color:${C.textPrimary};line-height:1.1;">Typography<br><em style="font-weight:400;font-style:italic;">in numbers</em></h2>`, {
          id: "s10-title",
          x: contentX,
          y: safe.y + 40,
          w: contentW
        }),
        headingRule("s10-rule", contentX, Ne("s10-title", { gap: 20 }), 100),
        // Stat 1
        J(`<p style="font-family:${SERIF};font-size:80px;font-weight:700;color:${C.textPrimary};line-height:1;margin:0;">500K+</p>`, {
          id: "s10-n1",
          x: contentX,
          y: Ne("s10-rule", { gap: 36 }),
          w: contentW,
          h: 85
        }),
        J(`<p style="font-family:${SANS};font-size:18px;font-weight:300;color:${C.textMuted};letter-spacing:0.02em;">Fonts available across all digital platforms</p>`, {
          id: "s10-l1",
          x: contentX,
          y: Ne("s10-n1", { gap: 10 }),
          w: contentW
        ...
        // Stat 2
        J(`<p style="font-family:${SERIF};font-size:80px;font-weight:700;color:${C.textPrimary};line-height:1;margin:0;">3,500</p>`, {
          id: "s10-n2",
          x: contentX,
          y: Ne("s10-div1", { gap: 24 }),
          w: contentW,
          h: 85
        }),
        J(`<p style="font-family:${SANS};font-size:18px;font-weight:300;color:${C.textMuted};letter-spacing:0.02em;">Years of typographic evolution</p>`, {
          id: "s10-l2",
          x: contentX,
          y: Ne("s10-n2", { gap: 10 }),
          w: contentW
        ...
        // Stat 3
        J(`<p style="font-family:${SERIF};font-size:80px;font-weight:700;color:${C.textPrimary};line-height:1;margin:0;">$47B</p>`, {
          id: "s10-n3",
          x: contentX,
          y: Ne("s10-div2", { gap: 24 }),
          w: contentW,
          h: 85
        }),
        J(`<p style="font-family:${SANS};font-size:18px;font-weight:300;color:${C.textMuted};letter-spacing:0.02em;">Global font licensing market valuation</p>`, {
          id: "s10-l3",
          x: contentX,
          y: Ne("s10-n3", { gap: 10 }),
          w: contentW
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        ...
        const elements = [
          ...
          J(`<h2 style="font-family:${SERIF};font-size:48px;font-weight:700;color:${C.textPrimary};line-height:1.1;">Design <em style="font-weight:400;font-style:italic;">process</em></h2>`, {
            id: "s11-title",
            x: cx,
            y: safe.y + 40,
            w: tw
          }),
          headingRule("s11-rule", cx, Ne("s11-title", { gap: 20 }), 100),
          J(`<p style="font-family:${SANS};font-size:20px;font-weight:300;color:${C.textMuted};line-height:1.6;letter-spacing:0.02em;">The journey from concept to finished typeface follows these key stages.</p>`, {
            id: "s11-desc",
            x: cx,
            y: Ne("s11-rule", { gap: 20 }),
            w: 700
          })
        ];
        for (let i = 0; i < steps.length; i++) {
          ...
          elements.push(
            J(`<div style="width:100%;height:100%;border:1px solid ${C.border};padding:20px;">
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        ...
        const elements = [
          ...
          J(`<h2 style="font-family:${SERIF};font-size:48px;font-weight:700;color:${C.textPrimary};line-height:1.1;">Type <em style="font-weight:400;font-style:italic;">timeline</em></h2>`, {
            id: "s12-title",
            x: cx,
            y: safe.y + 40,
            w: tw
          }),
          headingRule("s12-rule", cx, Ne("s12-title", { gap: 20 }), 100),
          // Horizontal line
          J("", {
            id: "s12-line",
            x: cx,
        ...
        for (let i = 0; i < events.length; i++) {
          ...
          elements.push(
            J(`<div style="width:12px;height:12px;border-radius:50%;background:${C.textPrimary};"></div>`, {
              id: `s12-dot${i}`,
              x: nx - 6,
              y: lineY - 5,
              w: 12,
          ...
          if (above) {
            elements.push(
              J(`<p style="font-family:${SERIF};font-size:28px;font-weight:400;font-style:italic;color:${C.textPrimary};line-height:1.2;margin:0;">${e.title}</p>`, {
                id: `s12-evtitle${i}`,
                x: nx - 10,
                y: lineY - 110,
                w: labelW
              }),
              J(`<p style="font-family:${SANS};font-size:15px;font-weight:300;color:${C.textMuted};line-height:1.5;">${e.desc}</p>`, {
                id: `s12-evdesc${i}`,
                x: nx - 10,
                y: lineY - 70,
                w: labelW
              }),
              J(`<p style="font-family:${SERIF};font-size:18px;font-weight:700;color:${C.textPrimary};">${e.year}</p>`, {
                id: `s12-year${i}`,
                x: nx - 10,
                y: lineY + 20,
                w: 100
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        ...
        const elements = [
          ...
          J(`<h2 style="font-family:${SERIF};font-size:48px;font-weight:700;color:${C.textPrimary};line-height:1.1;">Font usage <em style="font-weight:400;font-style:italic;">distribution</em></h2>`, {
            id: "s13-title",
            x: cx,
            y: safe.y + 40,
            w: tw
          }),
          headingRule("s13-rule", cx, Ne("s13-title", { gap: 20 }), 100),
          J(`<p style="font-family:${SANS};font-size:18px;font-weight:300;color:${C.textMuted};line-height:1.5;">Google Fonts downloads by classification (2024)</p>`, {
            id: "s13-sub",
            x: cx,
            y: Ne("s13-rule", { gap: 16 }),
            w: 600
          })
        ];
        for (let i = 0; i < bars.length; i++) {
          ...
          elements.push(
            J(`<p style="font-family:${SANS};font-size:16px;font-weight:300;color:${C.textMuted};line-height:${barH}px;text-align:right;">${b.label}</p>`, {
              id: `s13-blabel${i}`,
              x: cx,
              y: by,
              w: 120,
            ...
            J(`<div style="width:100%;height:100%;background:${C.textPrimary};opacity:0.85;"></div>`, {
              id: `s13-bar${i}`,
              x: chartX,
              y: by + 8,
              w: bw,
            ...
            J(`<p style="font-family:${SANS};font-size:15px;font-weight:400;color:${C.textPrimary};line-height:${barH}px;">${Math.round(b.pct * 100)}%</p>`, {
              id: `s13-bpct${i}`,
              x: chartX + bw + 16,
              y: by,
              w: 60,
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        ...
        const elements = [
          ...
          J(`<h2 style="font-family:${SERIF};font-size:48px;font-weight:700;color:${C.textPrimary};line-height:1.1;">Vertical <em style="font-weight:400;font-style:italic;">steps</em></h2>`, {
            id: "s14-title",
            x: cx,
            y: safe.y + 40,
            w: tw
          }),
          headingRule("s14-rule", cx, Ne("s14-title", { gap: 20 }), 100)
        ];
        for (let i = 0; i < steps.length; i++) {
          const s = steps[i];
          const sy = stepStartY + i * stepH;
          elements.push(
            J(`<p style="font-family:${SERIF};font-size:52px;font-weight:700;color:${C.textPrimary};line-height:1;">${s.num}</p>`, {
              id: `s14-num${i}`,
              x: cx,
              y: sy,
              w: 100,
            ...
            J(`<p style="font-family:${SERIF};font-size:26px;font-weight:400;font-style:italic;color:${C.textPrimary};line-height:1.2;">${s.title}</p>`, {
              id: `s14-stitle${i}`,
              x: cx + 120,
              y: sy + 4,
              w: 400,
            ...
            J(`<p style="font-family:${SANS};font-size:17px;font-weight:300;color:${C.textMuted};line-height:1.6;letter-spacing:0.02em;">${s.desc}</p>`, {
              id: `s14-sdesc${i}`,
              x: cx + 120,
              y: sy + 44,
              w: 700
    ...
    // ================================================================
    {
      ...
      elements: [
        ...
        J(`<h2 style="font-family:${SERIF};font-size:48px;font-weight:700;color:${C.textPrimary};line-height:1.1;">Device <em style="font-weight:400;font-style:italic;">mockup</em></h2>`, {
          id: "s15-title",
          x: safe.x + 60,
          y: safe.y + 40,
          w: 500
        }),
        headingRule("s15-rule", safe.x + 60, Ne("s15-title", { gap: 20 }), 100),
        // Phone mockup frame
        J(`<div style="width:100%;height:100%;border:2px solid ${C.border};padding:12px;">
        ...
        // Laptop mockup frame
        J(`<div style="width:100%;height:100%;border:2px solid ${C.border};padding:10px;">
        ...
        // Laptop base
        J(`<div style="width:100%;height:100%;border-bottom:2px solid ${C.border};border-left:2px solid ${C.border};border-right:2px solid ${C.border};"></div>`, {
          id: "s15-laptop-base",
          x: 960,
          y: safe.y + 700,
          w: 780,
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        ...
        return [
          ...
          J(`<h2 style="font-family:${SERIF};font-size:48px;font-weight:700;color:${C.textPrimary};line-height:1.1;">Photo <em style="font-weight:400;font-style:italic;">gallery</em></h2>`, {
            id: "s16-title",
            x: gx,
            y: safe.y + 40,
            w: gw
          }),
          headingRule("s16-rule", gx, Ne("s16-title", { gap: 20 }), 100),
          // Large landscape
          photoPlaceholder("s16-img1", gx, gy, largeW, topH, 190),
          // Tall portrait
          photoPlaceholder("s16-img2", gx + largeW + gap, gy, smallW, topH, 30),
          // Bottom left
          photoPlaceholder("s16-img3", gx, gy + topH + gap, largeW * 0.48, botH, 350),
          // Bottom center-right
          photoPlaceholder("s16-img4", gx + largeW * 0.48 + gap, gy + topH + gap, largeW * 0.52, botH, 160),
          // Bottom right
          photoPlaceholder("s16-img5", gx + largeW + gap, gy + topH + gap, smallW, botH, 220),
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        ...
        const elements = [
          ...
          J(`<h2 style="font-family:${SERIF};font-size:48px;font-weight:700;color:${C.textPrimary};line-height:1.1;">The <em style="font-weight:400;font-style:italic;">team</em></h2>`, {
            id: "s17-title",
            x: cx,
            y: safe.y + 40,
            w: totalW
          }),
          headingRule("s17-rule", cx, Ne("s17-title", { gap: 20 }), 100),
          J(`<p style="font-family:${SANS};font-size:20px;font-weight:300;color:${C.textMuted};line-height:1.5;">Legends of typographic design and lettering artistry</p>`, {
            id: "s17-sub",
            x: cx,
            y: Ne("s17-rule", { gap: 16 }),
            w: 700
          })
        ];
        for (let i = 0; i < team.length; i++) {
          ...
          elements.push(
            ...
            J(`<div style="width:${circleSize}px;height:${circleSize}px;border-radius:50%;background:linear-gradient(135deg, hsl(${190 + i * 30},25%,38%), hsl(${200 + i * 30},20%,30%));display:flex;align-items:center;justify-content:center;">
              <span style="font-family:${SERIF};font-size:32px;font-weight:700;color:${C.textPrimary};">${t.initials}</span>
            </div>`, {
              id: `s17-avatar${i}`,
            ...
            J(`<p style="font-family:${SERIF};font-size:22px;font-weight:400;font-style:italic;color:${C.textPrimary};text-align:center;line-height:1.2;">${t.name}</p>`, {
              id: `s17-name${i}`,
              x: colX,
              y: profileY + circleSize + 24,
              w: colW
            }),
            J(`<p style="font-family:${SANS};font-size:16px;font-weight:300;color:${C.textMuted};text-align:center;letter-spacing:0.02em;">${t.role}</p>`, {
              id: `s17-role${i}`,
              x: colX,
              y: profileY + circleSize + 56,
              w: colW
            })
          );
        }
    ...
    // ================================================================
    {
      ...
      elements: [
        ...
        photoPlaceholder("s18-photo", panelW, 0, panelW, 1080, 15),
        lBorder("s18-lb-tl", contentX - 20, 80, 120, 120, "tl"),
        J(`<h2 style="font-family:${SERIF};font-size:48px;font-weight:700;color:${C.textPrimary};line-height:1.1;">Get in <em style="font-weight:400;font-style:italic;">touch</em></h2>`, {
          id: "s18-title",
          x: contentX,
          y: safe.y + 80,
          w: contentW
        }),
        headingRule("s18-rule", contentX, Ne("s18-title", { gap: 20 }), 100),
        // Contact details
        J(`<p style="font-family:${SANS};font-size:16px;font-weight:400;color:${C.textPrimary};letter-spacing:0.05em;text-transform:uppercase;margin:0 0 8px 0;">Phone</p>
        <p style="font-family:${SANS};font-size:20px;font-weight:300;color:${C.textMuted};line-height:1.6;">+1 (555) 012-3456</p>`, {
          id: "s18-phone",
          x: contentX,
          y: Ne("s18-rule", { gap: 40 }),
          w: contentW
        }),
        J(`<p style="font-family:${SANS};font-size:16px;font-weight:400;color:${C.textPrimary};letter-spacing:0.05em;text-transform:uppercase;margin:0 0 8px 0;">Email</p>
        <p style="font-family:${SANS};font-size:20px;font-weight:300;color:${C.textMuted};line-height:1.6;">hello@typographystudio.com</p>`, {
          id: "s18-email",
          x: contentX,
          y: Ne("s18-phone", { gap: 36 }),
          w: contentW
        }),
        J(`<p style="font-family:${SANS};font-size:16px;font-weight:400;color:${C.textPrimary};letter-spacing:0.05em;text-transform:uppercase;margin:0 0 8px 0;">Address</p>
        <p style="font-family:${SANS};font-size:20px;font-weight:300;color:${C.textMuted};line-height:1.6;">42 Letterform Lane<br>San Francisco, CA 94102</p>`, {
          id: "s18-address",
          x: contentX,
          y: Ne("s18-email", { gap: 36 }),
          w: contentW
        }),
        J(`<p style="font-family:${SANS};font-size:16px;font-weight:400;color:${C.textPrimary};letter-spacing:0.05em;text-transform:uppercase;margin:0 0 8px 0;">Website</p>
        <p style="font-family:${SANS};font-size:20px;font-weight:300;color:${C.textMuted};line-height:1.6;">www.typographystudio.com</p>`, {
          id: "s18-web",
          x: contentX,
          y: Ne("s18-address", { gap: 36 }),
          w: contentW
        }),
    ...
    // ================================================================
    {
      ...
      elements: [
        ...
        photoPlaceholder("s19-photo", panelW, 0, panelW, 1080, 40),
        lBorder("s19-lb-tl", contentX - 20, 80, 150, 150, "tl"),
        lBorder("s19-lb-br", panelW - contentX - 150, 1080 - 230, 150, 150, "br"),
        J(`<h1 style="font-family:${SERIF};font-size:86px;font-weight:400;font-style:italic;color:${C.textPrimary};line-height:1.1;">Thank<br>you.</h1>`, {
          id: "s19-title",
          x: contentX,
          y: 340,
          w: contentW
        }),
        headingRule("s19-rule", contentX, Ne("s19-title", { gap: 32 }), 80),
        J(`<p style="font-family:${SANS};font-size:20px;font-weight:300;color:${C.textMuted};line-height:1.6;letter-spacing:0.02em;">Questions? Let's talk type.</p>`, {
          id: "s19-sub",
          x: contentX,
          y: Ne("s19-rule", { gap: 20 }),
          w: contentW
        }),
    ...
    // ================================================================
    {
      ...
      elements: (() => {
        const cx = safe.x + 60;
        const tw = safe.w - 120;
        const { left, right } = en({ x: cx, y: safe.y + 180, w: tw, h: safe.h - 220 }, { ratio: 0.5, gap: 80 });
        const catA = {
          title: "Typography Icons",
          icons: ["Aa", "Bb", "Tt", "Ff", "\xB6", "\xA7", "\xA9", "\xAE", "\u2122", "\u221E", "\u2248", "\xB1", "\xF7", "\xD7", "\xB5", "\u03A9"]
        };
        const catB = {
          title: "Layout Icons",
          icons: ["\u2630", "\u25A4", "\u25A5", "\u25EB", "\u229E", "\u229F", "\u25A6", "\u25E7", "\u25E8", "\u25A7", "\u25A8", "\u25A9", "\u2B1A", "\u2B21", "\u2B22", "\u25EF"]
        ...
        function renderIcons(icons, startX, startY, areaW, prefix) {
          ...
          for (let i = 0; i < icons.length; i++) {
            ...
            elems.push(
              J(`<p style="font-size:24px;color:${C.iconResource};text-align:center;line-height:${iconSize}px;">${icons[i]}</p>`, {
                id: `${prefix}${i}`,
                x: ix,
                y: iy,
                w: iconSize,
        ...
        return [
          J(`<h2 style="font-family:${SERIF};font-size:48px;font-weight:700;color:${C.textPrimary};line-height:1.1;">Resource <em style="font-weight:400;font-style:italic;">assets</em></h2>`, {
            id: "s20-title",
            x: cx,
            y: safe.y + 40,
            w: tw
          }),
          headingRule("s20-rule", cx, Ne("s20-title", { gap: 20 }), 100),
          // Category A heading
          J(`<p style="font-family:${SANS};font-size:16px;font-weight:400;color:${C.textPrimary};text-transform:uppercase;letter-spacing:0.06em;">${catA.title}</p>`, {
            id: "s20-catA",
            x: left.x,
            y: left.y,
            w: left.w,
          ...
          // Category B heading
          J(`<p style="font-family:${SANS};font-size:16px;font-weight:400;color:${C.textPrimary};text-transform:uppercase;letter-spacing:0.06em;">${catB.title}</p>`, {
            id: "s20-catB",
            x: right.x,
            y: right.y,
            w: right.w,
